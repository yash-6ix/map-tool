    ...
    <>
      ...
      <div className="w-full lg:max-w-5xl text-center mt-12 md:mt-20 mx-auto">
        ...
        <div className="w-full flex justify-center">
          <AgeWraper>
            <div>
              <SubTitle active={true} page={true}>
                {" "}
                {langData[lang].ask_age}
              </SubTitle>
            </div>
        ...
        <div className="w-full mt-10">
          <BigSubTitle active={false}>
            {langData[lang].question_title}
          </BigSubTitle>
        ...
        <div className="w-full p-6 md:p-12 bg-[color:var(--tertiary-accent-sand)] mt-24 text-left rounded-3xl">
          <div className="mb-6 md:mb-12">
            <div className="mb-2">
              <SecondSubTitle active={false}>
                {langData[lang].intervention_title}
              </SecondSubTitle>
            </div>
            <SubText>{langData[lang].intervention_subtitle}</SubText>
          </div>
